...
public:
    ...
    virtual void update_num_cores(int num_cores) = 0;           // TODO@insmod private side
    virtual void resize_memory(const MemorySize& new_size) = 0; // TODO@insmod private side
    virtual void resize_disk(const MemorySize& new_size) = 0;   // TODO@insmod private side
